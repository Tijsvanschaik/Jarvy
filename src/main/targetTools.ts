...
import type { RickyToolResult } from "../shared/types";
...
export type TargetToolDependencies = {
  ...
  board: BoardStore;
  notes: NotesStore;
  generateImage: (args: { prompt: string; size?: string }, signal: AbortSignal) => Promise<RickyToolResult>;
  searchWeb: (args: { query: string; numResults?: number }, signal: AbortSignal) => Promise<RickyToolResult>;
